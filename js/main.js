...
import {vPyqSetup,vPyqPractice,vPyqTest,vPyqResult} from './candidate/pyq.js';
...
function route(){const p=location.hash.slice(2).split('/');
 ...
 const R={login:vLogin,exam:vExam,test:vTest,result:vResult,history:vHistory,admin:vAdmin,pyq:vPyqSetup,pyqpractice:vPyqPractice,pyqtest:vPyqTest,pyqresult:vPyqResult};
